...
![完美二叉树的数组表示](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031554790.png)
...
![层序遍历序列对应多种二叉树可能性](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031555245.png)
...
![任意类型二叉树的数组表示](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031554589.png)

值得说明的是，**完全二叉树非常适合使用数组来表示**。回顾完全二叉树的定义，`None` 只出现在最底层且靠右的位置，**因此所有 `None` 一定出现在层序遍历序列的末尾**。

这意味着使用数组表示完全二叉树时，可以省略存储所有 `None` ，非常方便。图 7-15 给出了一个例子。

![完全二叉树的数组表示](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031554655.png)
