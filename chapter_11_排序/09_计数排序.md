...
## 11.9.1  简单实现[¶](https://www.hello-algo.com/chapter_sorting/counting_sort/#1191)
...
[![计数排序流程](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031928765.png)](https://www.hello-algo.com/chapter_sorting/counting_sort.assets/counting_sort_overview.png)
...
[![counting_sort_step8](https://www.hello-algo.com/chapter_sorting/counting_sort.assets/counting_sort_step8.png)](https://www.hello-algo.com/chapter_sorting/counting_sort.assets/counting_sort_step8.png)
...
**计数排序适用于数据量大但数据范围较小的情况**。比如，在上述示例中 � 不能太大，否则会占用过多空间。而当 �≪� 时，计数排序使用 �(�) 时间，可能比 �(�log⁡�) 的排序算法还要慢。