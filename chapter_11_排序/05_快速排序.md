...
![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051455854.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051455875.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456738.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456228.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456322.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456794.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456047.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456828.png)

![img](https://cdn.jsdelivr.net/gh/Zong-Liang/ImageBed@main//202404051456471.png)
...
![快速排序流程](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031927220.png)
...
- **空间复杂度为 $O(n)$、原地排序**：在输入数组完全倒序的情况下，达到最差递归深度 � ，使用 $O(n)$ 栈帧空间。排序操作是在原数组上进行的，未借助额外数组。
