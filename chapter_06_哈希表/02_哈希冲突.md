...
![链式地址哈希表](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031530086.png)
...
值得注意的是，当链表很长时，查询效率 $O(n)$ 很差。**此时可以将链表转换为“AVL 树”或“红黑树”**，从而将查询操作的时间复杂度优化至 $O(log\space n)$ 。
...
![开放寻址（线性探测）哈希表的键值对分布](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031530546.png)
...
![在开放寻址中删除元素导致的查询问题](https://cdn.jsdelivr.net/gh/ZL85/ImageBed@main/202404031530609.png)
