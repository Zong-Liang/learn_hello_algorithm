...
## 13.3.1  无重复元素的情况[¶](https://www.hello-algo.com/chapter_backtracking/subset_sum_problem/#1331)
...
### 1.  参考全排列解法[¶](https://www.hello-algo.com/chapter_backtracking/subset_sum_problem/#1)
...
### 2.  重复子集剪枝[¶](https://www.hello-algo.com/chapter_backtracking/subset_sum_problem/#2)
...
总结来看，给定输入数组 [�1,�2,…,��] ，设搜索过程中的选择序列为 [��1,��2,…,���] ，则该选择序列需要满足 �1≤�2≤⋯≤�� ，**不满足该条件的选择序列都会造成重复，应当剪枝**。
